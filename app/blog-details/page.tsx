  ...
  return (
    <>
      <section className="pb-[120px] pt-[150px]">
        ...
        <div className="mt-10">
                                <h3 className="mb-5 text-xl font-bold leading-tight text-black dark:text-white">
                                  Comments
                                </h3>
      ...
      <div className="flex items-center border border-gray-300 rounded-md ">
        <input
          ...
          className="px-40 py-20 text-base text-gray-800 placeholder-gray-500 border-0 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-l-md"
    ...
    <button
           className="absolute  right-[45%]  px-4 py-2 text-base font-medium text-white bg-blue-500 rounded-r-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
